    ...
    <div className="space-y-6">
      ...
      <section className="glass-panel space-y-4 p-5 md:p-7">
        ...
        <ul className="list-inside list-disc space-y-2 text-sm text-white/75">
          ...
          <li>
            <Link to="/replay" className="text-emerald-300 underline decoration-emerald-500/50 underline-offset-2 hover:text-emerald-200">
              Replay
            </Link>{" "}
            URLs rebuild a board from <code className="rounded bg-white/10 px-1">?moves=…</code> for fun or sharing — they do{" "}
      ...
      <p className="text-center text-sm text-white/45">
        <Link to="/play" className="text-emerald-300/90 underline-offset-2 hover:underline">
          Play
        </Link>
        {" · "}
        <Link to="/leaderboard" className="text-emerald-300/90 underline-offset-2 hover:underline">
          Hall of Fame
        </Link>
      </p>
    </div>
