  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-md">
      <div className="relative w-full max-w-sm">
        {celebrate ? (
          <div className="win-burst-bg absolute left-1/2 top-1/2 size-[min(120vw,48rem)] -translate-x-1/2 -translate-y-1/2" aria-hidden />
        ) : null}
        <div
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div className="mt-8 flex flex-col gap-3">
            ...
            <Link href="/" className="block w-full py-3 text-center text-sm text-white/50 transition hover:text-white">
              Home
            </Link>
          </div>
        </div>
